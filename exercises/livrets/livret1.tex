...
\noindent
Si besoin d'un corrigé, vous pouvez aussi me contacter, mais pas avant le Jour J : il est possible que je ne l'aie pas encore rédigé. Je rappelle que je suis étudiant, il est possible (voire probable) que je ne fasse pas de corrigé exhaustif lorsque je n'arrive pas moi-même à résoudre un exercice. \textbf{Réciproquement, si vous avez un corrigé à proposer pour un exercice, n'hésitez pas à me le faire parvenir !}
...
\section{Jour 8}
    ...
    \subsection{Algèbre}
    \ndlr{À venir : exercice d'approche sur les formes bilinéaires et quadratiques.}

    \subsection{Analyse}
    \ndlr{À venir : exercice sur les intégrales doubles.}

    \subsection{Probabilités}
    \ndlr{À venir : exercice d'examen sur les variables aléatoires et/ou les probabilités conditionnelles.}
...
\exercise{3}{Forme bilinéaire $\to$ forme quadratique}{
Soit la forme bilinéaire symétrique de $\mathbb{R}^3$ définie par :
\[ b(u, v) = 2u_1v_1 + 4u_1v_2 + 4u_2v_1 + 8u_2v_2 + 3u_3v_3 \]
\begin{enumerate}
    \item Écrire la forme quadratique $q$ associée à $b$.
...
\exercise{4}{Forme quadratique sur $\mathbb{R}^3$}{
...
\end{enumerate}
    ...
    \subsection{Analyse}
    \ndlr{À venir : exercice sur les séries entières/fonctions, avec CVU
}
...
\end{enumerate}
    ...
    \subsection{Algorithmique / Langage C}
