...
\section{Jour 1}
\attention{Le jour 1 est un peu plus compliqué et long que les autres, ne vous inquiétez pas si vous n'arrivez pas à faire tous les exercices.}
...
\section{Jour 3}
    ...
    \exercise{1}{Cours}{
        ...
        \begin{enumerate}
            ...
            \item le théorème de permutation somme - intégrales des séries de fonctions.
        \end{enumerate}
    }
...
\end{enumerate}
    ...
    \exercise{2}{Polynômes d'interpolation et dualité}{
        Soit $E = \mathbb{R}_n[X]$. On se donne une famille de $n+1$ réels $(a_0, \dots, a_n)$ deux à deux distincts. On définit pour $k \in \{0, \dots, n\}$ la forme linéaire $f_k : E \to \mathbb{R}$ par $f_k(P) = P(a_k)$, pour tout $P \in E$.\\
        On admet que \[\bigcap_{k=0}^n \ker(f_k) = \{0\} \Rightarrow (f_0, \dots, f_n) \text{ est une famille libre de } E^*\]
        \begin{enumerate}
