...
\exercise{3}{Distance à un plan}{On munit $\mathbb{R}^3$ du produit scalaire usuel. Soit $P$ le plan d'équation $2x + y - z + 2 = 0$. Déterminer le supplémentaire orthogonal de $P$ et donner la distance de $u = (3, 4, 5)$ à $P$.}
\newpage
\section{Jour 7}
\subsection{Algèbre}
