...
\exercise{40}{Algorithme de Karatsuba revisité}{
    On rappelle l'identité remarquable $2ab = (a + b)^2 - a^2 - b^2$. 
    \begin{enumerate}
        \item En déduire une expression de $(2^p \cdot a + b)^2$ faisant intervenir uniquement des puissances de 2 et les trois carrés $a^2$, $b^2$ et $(a + b)^2$.
        \item En déduire un algorithme de type "diviser pour régner" inspiré de l'algorithme de Karatsuba pour calculer le carré d'un entier de $n$ bits en temps $\Theta(n^{\log_2 3})$.
