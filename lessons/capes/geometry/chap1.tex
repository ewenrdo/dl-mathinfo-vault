...
\disclaimer{Les preuves proposées dans ce document sont génériques, et il semble que bon nombre d'entre-elles ne soient pas correctes. Il constitue toutefois un bon exercice de tenter de les corriger.}
...
\theorem{Théorème}{Inégalité triangulaire}{true}{
...
\ndlr{Une preuve serait la bienvenue.}
