...
\theorem{Proposition}{}{false}{
    ...
    Alors $(f_n)$ converge uniformément vers $f$ sur $I$ si et seulement si : $\|f_n - f\|_{I,\;\infty} \longrightarrow 0$.
}

\noindent{\textbf{Démonstration :}\\
    Remarque précédente + le sup est le plus petit majorant. $\Box$
}
