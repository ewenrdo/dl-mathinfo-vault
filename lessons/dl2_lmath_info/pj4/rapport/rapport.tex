...
Notamment, Stefan et Ewen on en partie travaillé sur les interfaces graphiques, qui sont plus longues mais paradoxalement moins complexes que les autres fonctionnalités du projet, ce qui explique en partie la répartition du travail entre les membres de l'équipe. Globalement, le travail a été réparti de manière relativement équitable entre les membres de l'équipe.\\\\
Chiffres : Laurent, Yaïr, Farzad, Ewen, Stefan ont respectivement contribué à hauteur de 16\%, 15.7\%, 16.3\%, 26.6\% et 25.5\% du code du projet, en termes de lignes ajoutées et supprimées.
