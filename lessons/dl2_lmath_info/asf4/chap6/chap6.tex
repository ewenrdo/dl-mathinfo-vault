...
\theorem{Proposition}{Trace et déterminant d'un endomorphisme}{false}{
    Soit $E$ un espace euclidien et $f \in \mathcal{L}(E)$ (pas forcément une isométrie, pas forcément autoadjoint).\\
    On a que :
    \begin{itemize}
        \item $tr(f)$ est la somme des valeurs propres de $f$ (comptées avec leur multiplicité),
        \item $det(f)$ est le produit des valeurs propres de $f$ (comptées avec leur multiplicité).
    \end{itemize}
}
