...
%Exemple f(x+iy)=x n’est pas holomorphe.				
%∂f/∂x=1+i0 ; ∂f/∂y=0+i0, mais si f était holomorphe, on aurait que la matrice	jacobienne en z_0=x_0+iy_0 est 
%(■(Re(∂f/∂x)(z_0 )&Re(∂f/∂y)(z_0 )@Im(∂f/∂x)(z_0 )&Im(∂f/∂y  )(z_0 ) ))=(■(a&-b@b&a)) 				
%où a+ib=f^' (z_0 ) et ce n’est pas vrai pour f(x+iy)=x.
