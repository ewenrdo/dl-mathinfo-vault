...
\definition{
    ...
    On dit que $f$ est \textbf{analytique} en $z_0 \in U$ s'il existe $r > 0$ tel que sur $D(z_0,r)$ il existe $\sum_{n=0}^{+\infty} a_n w^n$ une série entière de rayon de convergence $R \geq r$ tel que $\forall z \in \mathbb{C}, |z - z_0| < r \Rightarrow f(z) = \sum_{n=0}^{+\infty} a_n (z-z_0)^n$.\\\\
