...
\definition{
    ...
    \begin{enumerate}
        \item Deux vecteurs $x, y \in E$ sont \textbf{orthogonaux} si $\varphi(x,y) = 0$, on note $x \perp y$.
        \item L'orthogonal d'une partie $X \subseteq E$ est le sous-espace vectoriel $H^\perp = \{ z \in E \mid \forall x \in X, x \perp z \}$.
        \item Un vecteur $x \in E$ est dit \textbf{isotrope} si $x \perp x$.
    \end{enumerate}
}
...
\theorem{Proposition}{}{false}{
    Soit $E$ un $\mathbb{R}$-espace vectoriel de dimension finie $n$, et $\varphi$ une forme bilinéaire symétrique sur $E \times E$.\\
    Soit $F$ un sous-espace vectoriel de $E$.
    \begin{enumerate}
        \item On suppose qu'aucun vecteur non nul de $F$ n'est orthogonal à $E$ tout entier. Alors : $dim(F) + dim(F^\perp) = n$.
        \item Le résultat s'applique à tout sous-espace vectoriel $F$ de $E$ si $\varphi$ est non dégénérée.
    \end{enumerate}
}
