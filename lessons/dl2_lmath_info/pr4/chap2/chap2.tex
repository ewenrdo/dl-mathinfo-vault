...
%   Ω={1,2,…,6}={(ω_1,ω_2 ) ∶ω_i∈{1,2,…,6}}.							On a |Ω|=36.	P_uniforme ({ω})=1/36.
			%A= { résultat du 1e dé est 4} ={(4,ω) ∶ω∈{1,…,6}} ; |A|=6 et P(A)=6/36=1/6
			%B= {la somme est égale à 4} ={(1,3),(3,1),(2,2)}	P_n (B)=3/36.
...
\theorem{Proposition}{}{false}{
    Soit $(E_1, E_2, \ldots , E_n)$ une partition de $\Omega$ finie.\\
    On a $\mathbb{P}(\bigcup_{i=1}^{n} E_i) \leq \sum_{i=1}^{n} \mathbb{P}(E_i)$.
}
\ndlr{cf. Laurent pour la preuve (faire une récurrence.)}
