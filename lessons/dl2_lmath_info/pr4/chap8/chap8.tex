...
\definition{
    Une \textbf{chaîne de Markov} à valeurs dans un ensemble au plus dénombrable $E$ est un processus stochastique $(X_n)_{n\in\mathbb{N}}$ tel que pour tout $n \in \mathbb{N}$ et pour tout $(i_0, \ldots, i_{n-1}, i, j) \in E^{n+2}$ :
    \[
