...
\section{Morphismes}
\ndlr{Section à rattraper, cf OneNote}
    
\section{Ordres}
\ndlr{Section à rattraper jusqu'à corollaire "Tout groupe cyclique d'ordre n est isomorphe à Z/nZ", cf OneNote. Y ajoute l'exemple vu en TD sur ({-1,1}, x)}

\vocabulary{On appelle \textbf{ordre} d'un ensemble G son cardinal.}

\theorem{Proposition}{Ordre d'un élément}{false}{
    Soit $g \in G$, G fini.\\
    On a un morphisme $exp_g : \mathbb{Z} \rightarrow \mathbb{G}$, $n \mapsto g^n=exp_g(n)$.\\
