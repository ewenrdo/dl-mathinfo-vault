...
\example{
    $\sum_{n\geq1} \frac{e^{in\theta}}{n}$, on voit qu'elle n'est pas ACV, mais $|\frac{e^{in\theta}}{n}| = 1$ $\forall \theta \in \mathbb{R}$.\\
...
\ndlr{Démo au prochain cours, retirer le \textit{true} de la proposition}
