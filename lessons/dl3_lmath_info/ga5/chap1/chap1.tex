...
\theorem{Propriété}{Unicité du symétrique}{false}{
    Soit $E$ un ensemble muni d'une loi de composition interne associative. Supposons que $*$ admet un élément neutre $e$. Si $x \in G$ admette un symétrique pour $*$, alors ce symétrique est unique.
}
