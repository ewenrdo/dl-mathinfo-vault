...
\ndlr{La propriété précédente est dans un exercice de la partie I, à laisser ?}

\attention{La méthode pour démontrer qu'une application est injective ou surjective (et donc bijective) est considérée comme acquise.}
...
\noindent{\textbf{Démonstration :}\\
    Soient $(G, \cdot), (G', *), (G'', \times)$ des groupes.\\
