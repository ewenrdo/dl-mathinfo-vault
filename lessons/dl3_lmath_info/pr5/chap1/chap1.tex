...
\theorem{Proposition}{Propriété des mesures positives}{false}{
    ...
    \begin{enumerate}
        ...
        \item $\mu$ est continue par rapport à la suite décroissante : si $(A_n)_{n \in \mathbb{N}} \in \mathcal{F}^\mathbb{N}$ est une suite décroissante et $\mu(A_0) < +\infty$, alors $\mu(\bigcap_{n \in \mathbb{N}} A_n) = \lim_{n \to +\infty} \mu(A_n)$.
    \end{enumerate}
}
\noindent{\textbf{Preuve :} suit directement les définitions.}
\newpage
